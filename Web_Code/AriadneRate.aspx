<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AriadneRate.aspx.cs" Inherits="ariadneSort" %>
...
<body>
    ...
    <form runat="server">
        ...
        <asp:ImageButton ID="saverateresulttoserverandback" CssClass="savebuttonbp" runat="server" Text="Save & back" OnClick="saverateresultandback_Click" ImageUrl="~/images/icon-home2.png"></asp:ImageButton>
